...
parser.add_argument('--train_path', metavar='DIR',
                    help='path to training data', default=TRAIN_PATH)
...
parser.add_argument('--saved_values_path', metavar='DIR',
                    help='saved_values', default=SAVED_VALUES_PATH)
...
experiment.add_argument('--save_folder', default=SAVE_FOLDER,
