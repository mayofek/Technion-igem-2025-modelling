...
parser.add_argument('--fine_model_path', metavar='DIR',
                    help='', default="D:/SP_designer/classification/Transformer/SP2_trans_SP1/fine_CharTransformer_best.pth.tar")
...
parser.add_argument('--saved_values_path', metavar='DIR',
                    help='saved_values', default="D:/SP_designer/classification/Transformer/SP2_trans_SP1/saved_values.xlsx")
...
learn.add_argument('--batch_size', type=int, default=72, help='batch size for training [default: 64]')
...
parser.add_argument("--T-max", type=int, default=70, help="maximum number of iterations for CosineAnnealingLR")
...
def train_and_evaluate(model, train_loader, valid_loader, optimizer, scheduler, args):
    ...
    model_best = CharTransformer(args)
...
def train(train_dataloader, valid_dataloader, model, optimizer, scheduler, args):
    ...
    for epoch in range(start_epoch, args.epochs + 1):
        ...
        if best_acc is None or val_acc > best_acc:
            # file_path = 'D:/SP_designer/classification/Transformer/SP2_trans_SP1/fine_CharTransformer_best.pth.tar'
