...
parser.add_argument('--model_path', metavar='DIR',
                    help='', default="D:/SP_designer/classification/CNN/only_SP2/CharCNN_best.pth.tar")
...
parser.add_argument('--saved_values_path', metavar='DIR',
                    help='saved_values', default="D:/SP_designer/classification/CNN/only_SP2/saved_values.xlsx")
...
experiment.add_argument('--save_folder', default='D:/SP_designer/classification/CNN/only_SP2',
...
def train_and_evaluate(model, train_loader, valid_loader, optimizer, scheduler, args):
    ...
    model.eval()
    # Load the MLP model that was just trained, not the old CNN model
