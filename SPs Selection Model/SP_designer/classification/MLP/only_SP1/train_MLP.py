...
from classification.MLP.model_MLP import CharMLP
...
parser.add_argument('--model_path', metavar='DIR',
                    help='', default="D:/SP_designer/classification/CNN/only_SP1/CharCNN_best.pth.tar")
...
parser.add_argument('--saved_values_path', metavar='DIR',
                    help='saved_values', default="D:/SP_designer/classification/CNN/only_SP1/saved_values.xlsx")
...
learn.add_argument('--batch_size', type=int, default=45, help='batch size for training [default: 64]')
...
experiment.add_argument('--save_folder', default='D:/SP_designer/classification/CNN/only_SP1',
