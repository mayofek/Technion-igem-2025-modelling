...
parser.add_argument("--T_max", type=int, default=57, help="maximum number of iterations for CosineAnnealingLR")
...
experiment.add_argument('--save_folder', default='D:/SP_designer/classification/CNN/SP2_trans_SP1',
...
def train_and_evaluate(model, train_loader, valid_loader, optimizer, scheduler, args):
    ...
    model.eval()
    mlp_model_path = '%s/CharMLP_best.pth.tar' % (args.save_folder)
    checkpoint = torch.load(mlp_model_path, map_location=args.device)
