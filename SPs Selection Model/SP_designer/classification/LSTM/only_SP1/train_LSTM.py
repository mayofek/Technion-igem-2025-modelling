...
parser.add_argument('--train_path', metavar='DIR',
                    help='path to training data csv', default=r'D:/SP_designer/data/SP1.xlsx')
parser.add_argument('--model_path', metavar='DIR',
                    help='', default="D:/SP_designer/classification/LSTM/only_SP1/CharLSTM_best.pth.tar")
...
parser.add_argument('--saved_values_path', metavar='DIR',
                    help='saved_values', default="D:/SP_designer/classification/LSTM/only_SP1/saved_values.xlsx")
...
learn.add_argument('--batch_size', type=int, default=75, help='batch size for training [default: 64]')
...
experiment.add_argument('--save_folder', default='D:/SP_designer/classification/LSTM/only_SP1',
