...
parser.add_argument('--model_path', metavar='DIR',
                    help='', default="D:/SP_designer/regression/LSTM/SP2_and_SP1/CharLSTM_best.pth.tar")
...
parser.add_argument('--saved_values_path', metavar='DIR',
                    help='saved_values', default="D:/SP_designer/regression/LSTM/SP2_and_SP1/saved_values.xlsx")
...
learn.add_argument('--batch_size', type=int, default=130, help='batch size for training [default: 64]')
...
experiment.add_argument('--save_folder', default='D:/SP_designer/regression/LSTM/SP2_and_SP1',
...
def train_and_evaluate(model, train_loader, valid_loader, optimizer, scheduler, args):
    ...
    print("————————")
    pearson_corr, spearma_corr, r_squared, rmse = evaluate_regression(true_labels, predictions)
    print(f"Pearson Correlation: {pearson_corr}")
    print(f'Spearman Correlation: {spearma_corr}')
    print(f"R^2 Score: {r_squared}")
    print(f"RMSE: {rmse}")

    return pearson_corr, spearma_corr, r_squared, rmse, predictions, true_labels
