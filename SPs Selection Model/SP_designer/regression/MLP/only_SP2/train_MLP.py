...
parser.add_argument('--model_path', metavar='DIR',
                    help='', default="D:/SP_designer/regression/MLP/only_SP2/CharMLP_best.pth.tar")
...
parser.add_argument('--saved_values_path', metavar='DIR',
                    help='saved_values', default="D:/SP_designer/regression/MLP/only_SP2/saved_values.xlsx")
...
learn.add_argument('--batch_size', type=int, default=30, help='batch size for training [default: 64]')
...
experiment.add_argument('--save_folder', default='D:/SP_designer/regression/MLP/only_SP2',
