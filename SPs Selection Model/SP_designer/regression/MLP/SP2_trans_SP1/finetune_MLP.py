...
parser.add_argument('--pre_model_path', metavar='DIR',
                    help='', default="D:/SP_designer/regression/MLP/SP2_trans_SP1/CharMLP_best.pth.tar")
parser.add_argument('--fine_model_path', metavar='DIR',
                    help='', default="D:/SP_designer/regression/MLP/SP2_trans_SP1/fine_CharMLP_best.pth.tar")
...
parser.add_argument('--saved_values_path', metavar='DIR',
                    help='saved_values', default="D:/SP_designer/regression/MLP/SP2_trans_SP1/saved_values.xlsx")
...
parser.add_argument("--T_max", type=int, default=53, help="maximum number of iterations for CosineAnnealingLR")
