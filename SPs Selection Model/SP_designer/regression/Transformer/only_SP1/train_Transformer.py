...
from regression.Transformer.model_Transformer import CharTransformer
...
parser.add_argument('--train_path', metavar='DIR',
                    help='path to training data', default=r'D:/SP_designer/data/SP1.xlsx')

parser.add_argument('--model_path', metavar='DIR',
                    help='', default="D:/SP_designer/regression/Transformer/only_SP1/CharTransformer_best.pth.tar")
...
parser.add_argument('--saved_values_path', metavar='DIR',
                    help='saved_values', default="D:/SP_designer/regression/Transformer/only_SP1/saved_values.xlsx")
...
learn.add_argument('--batch_size', type=int, default=86, help='batch size for training [default: 64]')
...
Transformer.add_argument('--num_encoder_layers', type=int, default=1, help='')
Transformer.add_argument('--num_decoder_layers', type=int, default=1, help='')
Transformer.add_argument('--hidden_dim', type=int, default=8, help='')
Transformer.add_argument('--num_heads', type=int, default=2, help='')

# experiment options
experiment = parser.add_argument_group('Experiment options')
experiment.add_argument('--checkpoint', dest='checkpoint', default=True, action='store_true',
                        help='Enables checkpoint saving of model')
experiment.add_argument('--save_folder', default='D:/SP_designer/regression/Transformer/only_SP1',
...
def main():
    ...
    # 数据加载
    original_data = pd.read_excel(args.train_path)
    ...
    for fold, (train_index, valid_index) in enumerate(kf.split(dataset)):
        ...
        # 调用训练和验证
        pearson_corr, spearman_corr, r_squared, rmse, predictions, true_labels= train_and_evaluate(model, Train_dataloader, Valid_dataloader, optimizer, scheduler, args)
