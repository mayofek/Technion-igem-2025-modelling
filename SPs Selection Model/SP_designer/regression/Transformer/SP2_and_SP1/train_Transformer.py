...
parser.add_argument('--train_path', metavar='DIR',
                    help='path to training data', default=r'D:/SP_designer/data/SP1_and_SP2.xlsx')
...
parser.add_argument('--model_path', metavar='DIR',
                    help='', default="D:/SP_designer/regression/Transformer/SP2_and_SP1/CharTransformer_best.pth.tar")
...
parser.add_argument('--saved_values_path', metavar='DIR',
                    help='saved_values', default="D:/SP_designer/regression/Transformer/SP2_and_SP1/saved_values.xlsx")
...
learn.add_argument('--batch_size', type=int, default=80, help='batch size for training [default: 64]')
...
experiment.add_argument('--save_folder', default='D:/SP_designer/regression/Transformer/SP2_and_SP1',
...
def main():
    ...
    for fold, (_, valid_index) in enumerate(kf.split(test_set)):
        ...
        train_sampler = SubsetRandomSampler(range(train_set.__len__()))
