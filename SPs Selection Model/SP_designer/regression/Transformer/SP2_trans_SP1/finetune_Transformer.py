...
parser.add_argument('--pre_model_path', metavar='DIR',
                    help='', default="D:/SP_designer/regression/Transformer/SP2_trans_SP1/CharTransformer_best.pth.tar")
parser.add_argument('--fine_model_path', metavar='DIR',
                    help='', default="D:/SP_designer/regression/Transformer/SP2_trans_SP1/fine_CharTransformer_best.pth.tar")
...
parser.add_argument('--saved_values_path', metavar='DIR',
                    help='saved_values', default="D:/SP_designer/regression/Transformer/SP2_trans_SP1/saved_values.xlsx")
...
def train_and_evaluate(model, train_loader, valid_loader, optimizer, scheduler, args):
    ...
    print(f'Spearman Corrletation: {spearman_corr}')
